...
<ul class="nav nav-tabs">
    <li class="nav-item fw-bold">
        <a class="nav-link active" aria-current="page" href="{{ route('admin-transaction') }}">Buy Products</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin-transaction-sell') }}">Sell Product</a>
    </li>
</ul>
<div class="mt-3">
